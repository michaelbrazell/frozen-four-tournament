    ...
    return (
      <div className="row">
        <div className="col-xs-12 col-sm-12 col-md-8">
          ...
          a <a href="https://en.wikipedia.org/wiki/Fibonacci_number" target="_blank">fibbonacci sequence</a> for rewarding correct picks in later rounds, without under-valuing early rounds.</p>
          <ul>
          ...
          To view all of the changes sequentially, visit the <a href="https://github.com/michaelbrazell/frozen-four-tournament/commits/master" target="_blank">Github Repository</a>.</p>
